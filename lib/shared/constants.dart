...
class Doubles {
  static const double headerMargin = 10.0;
  static const double bodyMargin = 30.0;
}

class Palette {
  static const Color primary = Color(0xFFED7117);
  static const Color color2 = Color(0xFFF08B42);
  static const Color color3 = Color(0xFFF4A56C);
  static const Color color4 = Color(0xFFF7BF97);
  static const Color color5 = Color(0xFFFAD9C2);
  static const Color secondary = Color(0xFF8B3D04);
